<template>
	<div class="main-content" :style='{"minHeight":"100vh","padding":"0px 0px 20px","overflow":"hidden","color":"#666","background":"#f4f8fb","fontSize":"14px","position":"relative"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('xuesheng','积分奖励')" @click="jifenjiangliCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<jifenjiangli-cross-add-or-update v-if="jifenjiangliCrossAddOrUpdateFlag" :parent="this" ref="jifenjiangliCrossaddOrUpdate"></jifenjiangli-cross-add-or-update>
...
import jifenjiangliCrossAddOrUpdate from "../jifenjiangli/add-or-update";
	export default {
		data() {
			return {
				xingbieOptions: [],
				...
				jifenjiangliCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			jifenjiangliCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.jifenjiangliCrossAddOrUpdateFlag = true;
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.jifenjiangliCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.jifenjiangliCrossaddOrUpdate.init(row.id,type);
				});
			},
