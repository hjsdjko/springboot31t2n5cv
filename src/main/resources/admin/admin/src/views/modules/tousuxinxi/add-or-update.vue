<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'" label="投诉编号" prop="tousubianhao">
					<el-input v-model="ruleForm.tousubianhao" placeholder="投诉编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.tousubianhao" label="投诉编号" prop="tousubianhao">
					<el-input v-model="ruleForm.tousubianhao" placeholder="投诉编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="投诉时间" prop="tousushijian">
					<el-date-picker
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.tousushijian" label="投诉时间" prop="tousushijian">
					<el-input v-model="ruleForm.tousushijian" placeholder="投诉时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-if="type!='info'"  label="投诉内容" prop="tousuneirong">
					<editor 
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.tousuneirong" label="投诉内容" prop="tousuneirong">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"1000px","color":"inherit","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.tousuneirong"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tousuneirong = this.ruleForm.tousuneirong.replace(reg,'../../../springboot31t2n5cv/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
