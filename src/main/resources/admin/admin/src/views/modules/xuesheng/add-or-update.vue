	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="学科门类" prop="xuekemenlei">
					<el-select :disabled="ro.xuekemenlei" v-model="ruleForm.xuekemenlei" placeholder="请选择学科门类" >
						<el-option
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else class="input" label="学科门类" prop="xuekemenlei">
					<el-input v-model="ruleForm.xuekemenlei"
						placeholder="学科门类" readonly></el-input>
				</el-form-item>
